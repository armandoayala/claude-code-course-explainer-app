---
name: ui-designer
description: "UI/UX Design expert for flask web applications. Use when: 1. User request UI Design or layout changes. 2. Styling Improvements or Visual enhancements 3. Creating forms or interactive components 4. user says make it look better or mention css/styling 5. Build new feature that requires User Interface Design"
metadata: 
